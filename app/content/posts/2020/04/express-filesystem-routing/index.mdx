---
title: "Replicating Vercel Now's File-System Routing for Express"
...
Noted earlier, [express-fs-router](https://www.npmjs.com/package/express-fs-router) is a utility I wrote to bring file-system routing to Express. It functions a lot like Vercel Now's API routes, but with a bit of added functionality.
